...
issue](https://github.com/mcdonnnj/ansible-role-host-information/issues) in
...
request](https://github.com/mcdonnnj/ansible-role-host-information/pulls), you
...
```console
cd ansible-role-host-information
pyenv virtualenv <python_version_to_use> ansible-role-host-information
pyenv local ansible-role-host-information
